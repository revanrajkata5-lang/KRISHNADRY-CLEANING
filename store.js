...
// Admin login credentials (checked client-side before entering the admin console).
const ADMIN_USERNAME = "naniabhi";
const ADMIN_PASSWORD = "Abhi@0326";
  ...
  checkoutSummaryLines.innerHTML =
    entries.length > 0
      ? entries
          ...
          .join("")
      : `<div><span>No items selected — our staff will confirm items from your uploaded file.</span></div>`;
